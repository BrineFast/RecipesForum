package com.university.database.service.season;

import com.university.database.exception.entities.BadDataException;
...
public class SeasonService {
    ...
    public Season getSeason(Long seasonId){
        return seasonRepo.findById(seasonId).orElseThrow(() -> new ItemNotFoundException("Season with id " + seasonId + " not found."));
    }
    ...
    public Season editSeason(Long seasonId, SeasonEditDTO seasonEditDTO){
        Season season = seasonRepo.findById(seasonId).orElseThrow(() -> new ItemNotFoundException("Season with id " + seasonId + " not found."));
