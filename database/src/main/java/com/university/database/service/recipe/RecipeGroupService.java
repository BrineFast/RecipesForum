...
public class RecipeGroupService {
    ...
    public RecipeGroup getRecipeGroup(Long recipeGroupId){
        return recipeGroupRepo.findById(recipeGroupId).orElseThrow(() -> new ItemNotFoundException("RecipeGroup with id " + recipeGroupId.toString() + " not found."));
    }
    ...
    public RecipeGroup editRecipeGroup(Long recipeGroupId, RecipeGroupEditDTO recipeGroupEditDTO){
        RecipeGroup recipeGroup = recipeGroupRepo.findById(recipeGroupId).orElseThrow(() -> new ItemNotFoundException("RecipeGroup with id " + recipeGroupId.toString() + " not found."));
