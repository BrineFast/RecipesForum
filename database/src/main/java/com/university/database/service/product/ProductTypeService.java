...
public class ProductTypeService {
    ...
    public ProductType getRecipeGroup(Long productTypeId){
        return productTypeRepo.findById(productTypeId).orElseThrow(() -> new ItemNotFoundException("ProductType with id " + productTypeId.toString() + " not found."));
    }
    ...
    public ProductType editRecipeGroup(Long productTypeId, ProductTypeEditDTO productTypeEditDTO){
        ProductType productType = productTypeRepo.findById(productTypeId).orElseThrow(() -> new ItemNotFoundException("ProductType with id " + productTypeId.toString() + " not found."));
