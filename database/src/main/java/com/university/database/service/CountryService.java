...
import com.university.database.model.dao.CountryRepo;
...
public class CountryService {
    ...
    public Country getCountry(Long countryId){
        return countryRepo.findById(countryId).orElseThrow(() -> new ProductNotFoundException("Country with id " + countryId +  " not found."));
    }

    @Transactional
    public Country editCountry(Long countryId, CountryEditDTO countryEditDTO){
        Country country = countryRepo.findById(countryId).orElseThrow(() -> new ProductNotFoundException("Country with id " + countryId +  " not found."));
